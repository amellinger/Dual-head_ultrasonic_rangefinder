...
WindowTitle = 'Damped + Driven Oscillator  V 1.0'
...
global  fitline1, fitline2, fitline3, fitline4, arrow1, arrow2, arrow3, arrow4, dash1, dash2, span,\
    text1, text2, text3, text4, textdamped, textexp
arrow1=arrow2=arrow3=arrow4=dash1=dash2=span=text1=text2=text3=text4=textdamped=textexp=None
span2 = None
            ...
            [sg.Frame(layout=[[sg.Column([[sg.Canvas(key='controls_cv')], [sg.Canvas(key='-CANVAS-', size=(520,None))]]),
                               sg.Column([[sg.Frame(layout=[[sg.Text('Serial Port:')],
                                         ...
                                         title='Device', title_color='#FFC82E', size=(150,200)),
                                           sg.Frame(layout=[[sg.Column([[sg.Text('# of points\n(max. 1500)')]], size=(110,40)),
                                          ...
                                          [sg.Frame(layout=[[sg.Button('Acquire Data', key='-START-', size=12, disabled=False),
                                                             sg.Button('Fit Driven Osc.', key='-FitDriven-', size=12),
                                                             sg.Button('Close', size=12)],
                                                            [sg.FileSaveAs(button_text='Save Data', enable_events=True, file_types=(("TXT Files", "*.txt"),("ALL Files", "*.*")),
                                                                           size=12, key='-SaveData-' ),
...
def do_measurement():
    ...
    n = validate_int(values['-NPts-'], 10, 1500)
    print('n=', n)
...
ax2.set_ylabel('Botttom Distance (m)')
