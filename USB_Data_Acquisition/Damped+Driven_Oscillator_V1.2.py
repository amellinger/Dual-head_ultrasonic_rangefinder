...
WindowTitle = 'Damped + Driven Oscillator  V 1.2'
...
fit_text = ax2.text(0.98, 0.02, 'Click and drag in the bottom window to set the fit range. Click on white background to unset range.', fontsize=10, 
